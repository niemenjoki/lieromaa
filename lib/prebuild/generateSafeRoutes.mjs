...
import { getDeclaredLocalizedRoutes } from '../i18n/routes.mjs';
import { CONTENT_TYPES, POSTS_PER_PAGE } from '../site/constants.mjs';
...
function generate() {
  ...
  const safeRoutes = Array.from(
    new Set([...staticRoutes, ...dynamicRoutes, ...getDeclaredLocalizedRoutes()])
  ).sort();
