...
import { getActiveSkuDiscount } from '../pricing/skuDiscounts.mjs';
...
async function buildItems() {
  ...
  for (const [productKey, product] of Object.entries(productDefinitions)) {
    ...
    for (const sku of product.variantSkus) {
      ...
      const automaticDiscount = getActiveSkuDiscount({ sku, basePrice });
      const salePriceBlock = automaticDiscount
        ? `      <g:sale_price>${escapeXml(formatPrice(automaticDiscount.discountedPrice))}</g:sale_price>\n`
        : '';
