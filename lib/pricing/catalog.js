import pricingData from '@/data/operations/commerce/pricing.json';
...
export function getSkuPriceDetails(sku) {
  const basePrice = getBasePriceForSku(sku);
  const discount = getActiveSkuDiscount({ sku, basePrice });
