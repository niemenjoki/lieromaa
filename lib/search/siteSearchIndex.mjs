import { extractArticleHeadings } from '../content/articleHeadings.mjs';
...
function getMdxHeadings(source) {
  return extractArticleHeadings(source).map((heading) => heading.text);
}
...
export function getSiteSearchIndex() {
  ...
  const utilityPages = [
    ...
    createPageSearchItem(dataRequestPage, 'page', 'Sivu'),
  ];
