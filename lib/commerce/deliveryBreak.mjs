...
export const DELIVERY_BREAK_SHORT_NOTICE =
  'Tilauksia voi tehdä normaalisti, mutta niitä ei käsitellä, vahvisteta eikä toimiteta kesäloman aikana 29.6.–12.7.2026. Loman aikana tehdyt tilaukset käsitellään 13.7. alkaen saapumisjärjestyksessä.';

export const DELIVERY_BREAK_FULL_NOTICE_PARAGRAPHS = [
  'Tilauksia voi tehdä normaalisti myös kesäloman aikana, mutta Lieromaan tilauksia ei käsitellä, vahvisteta eikä toimiteta 29.6.–12.7.2026. Loman aikana tehdyt tilaukset käsitellään, vahvistetaan ja toimitetaan 13.7. alkaen saapumisjärjestyksessä.',
