...
const PREPARED_WORM_BIN_SHIPPING_KEY = 'preparedWormBin';
...
export function getBaseEstimatedShippingDate({ productKeys = [], orderDate }) {
  ...
  if (normalizedProductKeys.includes(PREPARED_WORM_BIN_SHIPPING_KEY)) {
    return getFollowingMonday(normalizedOrderDate, 3);
  }
