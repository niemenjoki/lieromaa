import {
  ...
  standalonePageDefinitions,
  starterKitSetupPageDefinition,
} from '../pages/pageDefinitions.mjs';
...
export const wormSourcePage = createPageRecord(standalonePageDefinitions.wormSource);
export const guideHubPage = createPageRecord(standalonePageDefinitions.guideHub);
...
export const cancellationRequestPage = createPageRecord(
  legalPageDefinitions.cancellationRequest
);
export const dataRequestPage = createPageRecord(legalPageDefinitions.dataRequest);
...
export const standaloneSitePages = Object.freeze({
  ...
  guideHub: guideHubPage,
  cancellationRequest: cancellationRequestPage,
  dataRequest: dataRequestPage,
  orderTerms: orderTermsPage,
  privacyPolicy: privacyPolicyPage,
  wormCalculator: wormCalculatorPage,
  wormSource: wormSourcePage,
});
