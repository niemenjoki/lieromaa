export const legalPageDefinitions = {
  privacyPolicy: {
    ...
    pageDescription:
      'Lieromaan tietosuojaseloste henkilötietojen käsittelystä, Stripe- ja laskumaksuista, evästeistä sekä kolmansien osapuolten palveluista.',
