      ...
      <div className={classes.AboutPage}>
        ...
        <div className={classes.Bio}>
          ...
          <p>
            ...
            lapsen isä ja innokas matokompostoinnin harrastaja. Päivätyössäni
            ohjelmoin lämpöpumppujärjestelmiä ja optimoin niitä toimimaan
            mahdollisimman energiatehokkaasti. Kestävä elintapa ja luonnon
            kiertokulku ovat minulle tärkeitä — niistä kumpuaa koko Luomulieron
            idea.
          </p>
