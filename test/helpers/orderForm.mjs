...
export function createValidOrderFormData(overrides = {}) {
  ...
  const defaults = {
    ...
    myyntiyksikko: scenario.variant?.salesUnit || '',
    paino_grammoina: scenario.variant?.weightGrams || '',
    arvioitu_matomäärä: scenario.variant?.estimatedWormCount || '',
