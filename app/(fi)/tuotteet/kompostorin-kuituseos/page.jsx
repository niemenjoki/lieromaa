        ...
        <div className={classes.Content}>
            ...
            <div className={classes.HeroDetails}>
              ...
              <aside className={classes.SummaryCard}>
                ...
                <ul className={classes.FeatureList}>
                  <li>
                    Erikseen tilattava 500 g pakkaus matokompostin ruokinnan tasaamiseen.
                  </li>
                  <li>
                    Pienempi 150 g pakkaus on saatavilla vain matopaketin lisävalintana.
                  </li>
          ...
          <section id="tilaa" className={classes.OrderSection}>
            <div className={classes.OrderSectionHeader}>
              ...
              <p>Hinta alkaen {formatPrice(variants[0]?.price ?? 0, 'fi')} €.</p>
            </div>

            <AddToCartPanel productKey="compostChow" language="fi" />
          </section>
        </div>
      </article>
    </>
