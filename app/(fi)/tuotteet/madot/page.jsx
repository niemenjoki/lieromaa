    ...
    <>
      ...
      <article className={classes.ProductPage}>
        ...
        <div className={classes.Content}>
          ...
          <ProductReviewsSection productKey="worms" language="fi" />
            ...
            <div className={classes.CardGrid}>
              ...
              <div className={classes.InfoCard}>
                ...
                <p>
                  ...
                  <strong>
                    {wormPickupOption?.label} (
                    {formatPrice(wormPickupOption?.price ?? 0, 'fi')} €)
                  </strong>{' '}
                  ,{' '}
                  <strong>
                    {wormHomeOption?.label} (
                    {formatPrice(wormHomeOption?.price ?? 0, 'fi')} €)
                  </strong>{' '}
                  tai{' '}
                  <strong>
                    {wormLocalPickupOption?.label} (
                    {formatPrice(wormLocalPickupOption?.price ?? 0, 'fi')} €)
                  </strong>
                  .
                </p>
                <p>
