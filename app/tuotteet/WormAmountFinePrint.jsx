...
export default function WormAmountFinePrint() {
  return (
    <p className={classes.FinePrint}>
      ...
      noin 0,4-0,6 g, mutta käytämme laskennassa varovaisempaa arviota 0,4 g / mato.
      Todellinen yksilömäärä voi vaihdella arviolta noin ±10 % matojen kokojakaumasta
      riippuen.
    </p>
  );
}
